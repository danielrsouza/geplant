                 ...
                 <ul class="navbar-nav mr-auto ml-auto"> <!-- Inicio UL -->
                      ...
                      <li class="nav-item dropdown active"> 
                         ...
                         <div class="dropdown-divider"></div> <!-- Linha de divisão menu dropdown -->
                                <a class="dropdown-item active" href="galeriaDeMdf.php"><img class="img-fluid" src="img/icon-mdf.png">&nbsp;Galeria de mdf</a>
                         </div>
  ...
  <section>
    <div class="container mb-5">
        ...
        <div class="page-header mb-5 mt-5 ">
            <h1>Galeria de MDFS&nbsp;<img src="img/icon-Galeriamdf.png"></h1>
        </div>
        ...
        <div class="row">
            ...
            <div class="mb-5 col-md-3" style="cursor: pointer;">
                <div class="fotos card">
                    <img class="card-img-top" src="img/mdf/amendoaRustica.jpg" alt="Card image cap" style="width: 100%; height: 100%;">
                    <div class="card-body">
                      <h2 class="card-title" style="text-align: center; color: #6e431e; font-size: 1em">MDF AMENDOA RÚSTICA</h2>
                    </div>
                </div>
            </div>
            ...
            <div class="mb-5 col-md-3" style="cursor: pointer;">
                <div class="fotos card">
                    <img class="card-img-top" src="img/mdf/brancoArtico.jpg" alt="Card image cap" style="width: 100%; height: 80%;">
                    <div class="card-body">
                      <h2 class="card-title" style="text-align: center; color: #6e431e; font-size: 1em">MDF BRANCO ÁRTICO</h2>
                    </div>
                </div>
            </div>
            ...
            <div class="mb-5 col-md-3" style="cursor: pointer;">
                <div class="fotos card">
                    <img class="card-img-top" src="img/mdf/cerezoLeon.jpg" alt="Card image cap" style="width: 100%; height: 100%;">
                    <div class="card-body">
                      <h2 class="card-title" style="text-align: center; color: #6e431e; font-size: 1em">MDF CEREZO LEON</h2>
                    </div>
                </div>
            </div>
            ...
            <div class="mb-5 col-md-3" style="cursor: pointer;">
                <div class="fotos card">
                    <img class="card-img-top" src="img/mdf/ciliegioColumbia.jpg" alt="Card image cap" style="width: 100%; height: 100%;">
                    <div class="card-body">
                      <h2 class="card-title" style="text-align: center; color: #6e431e; font-size: 1em">MDF CILIEGIO COLUMBIA</h2>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="mb-5 col-md-3" style="cursor: pointer;">
                <div class="fotos card">
                    <img class="card-img-top" src="img/mdf/ebanoMarone.jpg" alt="Card image cap" style="width: 100%; height: 80%;">
                    <div class="card-body">
                      <h2 class="card-title" style="text-align: center; color: #6e431e; font-size: 1em">MDF ÉBANO MARONE</h2>
                    </div>
                </div>
            </div>
            ...
            <div class="mb-5 col-md-3" style="cursor: pointer;">
                <div class="fotos card">
                    <img class="card-img-top" src="img/mdf/grisMontano.jpg" alt="Card image cap" style="width: 100%; height: 80%;">
                    <div class="card-body">
                      <h2 class="card-title" style="text-align: center; color: #6e431e; font-size: 1em">MDF GRIS MONTANO</h2>
                    </div>
                </div>
            </div>
            <div class="mb-5 col-md-3" style="cursor: pointer;">
                <div class="fotos card">
                    <img class="card-img-top" src="img/mdf/nogueiraCadiz.jpg" alt="Card image cap" style="width: 100%; height: 80%;">
                    <div class="card-body">
                      <h2 class="card-title" style="text-align: center; color: #6e431e; font-size: 1em">MDF NOGUEIRA CADIZ</h2>
                    </div>
                </div>
            </div>
            ...
            <div class="mb-5 col-md-3" style="cursor: pointer;">
                <div class="fotos card">
                    <img class="card-img-top" src="img/mdf/preto.jpg" alt="Card image cap" style="width: 100%; height: 80%;">
                    <div class="card-body">
                      <h2 class="card-title" style="text-align: center; color: #6e431e; font-size: 1em;">MDF PRETO</h2>
                    </div>
                </div>
            </div>
