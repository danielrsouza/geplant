...
<head>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light"> <!-- Navbar com o menu -->
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent"> 
                 <ul class="navbar-nav mr-auto ml-auto"> <!-- Inicio UL -->
                      ...
                      <li class="nav-item">
                               <a class="nav-link active" href="faleConosco.php"><img class="img-fluid" src="img/icon-faleConosco.png">&nbsp;Fale conosco</a>
                      </li>
                 </ul> <!-- Fim UL -->
             </div>
          </div>
 ...
 <section>
    ...
    <article>
      <div class="container">
        <h1 id="titulo-cadastro" class="mt-3 p-2">Seja um cliente cadastrado!&nbsp;<img src="img/icon-cliente-cadastrado.png"></h1>
        
        <form name="formulario" action="/contato" method="POST">
          ...
          <div class="form-group">
            ...
            <input class="form-control" type="number" id="telefone" name="telefone" placeholder="(00) 0000-00000" required="">
          </div>        

          <div class="form-group">
            <label for="email">E-mail</label>
            <input class="form-control" type="email" id="email" name="email" placeholder="Geplant@Geplant.com" required>
          </div>    

          <div class="form-group">
            <label for="descricao">Nos deixe uma mensagem</label>
            <br>
            <textarea class="form-control" id="descricao" placeholder="Descreva para nós ideias e sugestões!">
            </textarea>
          </div>    
